# 1 "F:/MCU_PROJECT/c_shell_sth7/projects/mdk/RTE/Device/STM32H750VBTx/STCubeGenerated/Src/stm32h7xx_hal_msp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "F:/MCU_PROJECT/c_shell_sth7/projects/mdk/RTE/Device/STM32H750VBTx/STCubeGenerated/Src/stm32h7xx_hal_msp.c" 2
# 22 "F:/MCU_PROJECT/c_shell_sth7/projects/mdk/RTE/Device/STM32H750VBTx/STCubeGenerated/Src/stm32h7xx_hal_msp.c"
# 1 "./RTE/Device/STM32H750VBTx/STCubeGenerated/Inc\\main.h" 1
# 30 "./RTE/Device/STM32H750VBTx/STCubeGenerated/Inc\\main.h"
...
# 31 "./RTE/Device/STM32H750VBTx/STCubeGenerated/Inc\\main.h" 2
# 53 "./RTE/Device/STM32H750VBTx/STCubeGenerated/Inc\\main.h"
void Error_Handler(void);
# 23 "F:/MCU_PROJECT/c_shell_sth7/projects/mdk/RTE/Device/STM32H750VBTx/STCubeGenerated/Src/stm32h7xx_hal_msp.c" 2



extern DMA_HandleTypeDef hdma_usart1_tx;
# 64 "F:/MCU_PROJECT/c_shell_sth7/projects/mdk/RTE/Device/STM32H750VBTx/STCubeGenerated/Src/stm32h7xx_hal_msp.c"
void HAL_MspInit(void)
{
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  if(huart->Instance==((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL)))
  {
    ...
    hdma_usart1_tx.Instance = ((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x028UL));
    hdma_usart1_tx.Init.Request = 42U;
    hdma_usart1_tx.Init.Direction = ((uint32_t)(0x1UL << (6U)));
    hdma_usart1_tx.Init.PeriphInc = ((uint32_t)0x00000000U);
    hdma_usart1_tx.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    hdma_usart1_tx.Init.PeriphDataAlignment = ((uint32_t)0x00000000U);
    hdma_usart1_tx.Init.MemDataAlignment = ((uint32_t)0x00000000U);
    hdma_usart1_tx.Init.Mode = ((uint32_t)0x00000000U);
    hdma_usart1_tx.Init.Priority = ((uint32_t)0x00000000U);
    hdma_usart1_tx.Init.FIFOMode = ((uint32_t)0x00000000U);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x0000UL)), ((uint16_t)0x0200)|((uint16_t)0x0400));
