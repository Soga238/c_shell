...
# 2 "<built-in>" 2
# 1 "RTE/CMSIS/RTX_Config.c" 2
# 28 "RTE/CMSIS/RTX_Config.c"
...
# 30 "RTE/CMSIS/RTX_Config.c" 2


__attribute__((weak)) __attribute__((__noreturn__)) void osRtxIdleThread (void *argument) {
  (void)argument;
...
__attribute__((weak)) uint32_t osRtxErrorNotify (uint32_t code, void *object_id) {
  (void)object_id;
